...
def main():
    ...
    while step<max_steps:
        ...
        print("Step:{}, Episode Timestep:{}, Reward:{:.2f}, Reward Per Step:{:.2f}".format(step,current_step,reward,reward/current_step))
        with open("log.txt", 'a') as file:
            file.write("Step:{}, Episode Timestep:{}, Reward:{:.2f}, Reward Per Step:{:.2f}".format(step, current_step,
                                                                                               reward,
                                                                                               reward / current_step))
        if epoch%10==0:
            agent.save("./ARS.npy")
